...
par(mfrow = c(2, 2))
boxplot(dane2$ApplicantIncome, dane2$CoapplicantIncome)
boxplot(dane2$Loan_Amount_Term, dane2$LoanAmount)
boxplot(dane2$Gender, dane2$Education, dane2$Credit_History, dane2$Self_Employed)
boxplot(dane2$Married, dane2$Dependents, dane2$Property_Area)  #bez odchyleń
```
```{r}
