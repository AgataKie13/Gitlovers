...
*ZNALEŹĆ ŁADNIEJSZY SPOSÓB WIZUALIZACJI TYCH OBLICZEŃ*
...
1. Czy ktoś bez dochodu dostał kredyt? - na daned
Credit_History = 1 & ApplicantIncome + CoapplicantIncome > 0 
czy Credit_History = 1 & ApplicantIncome > 0

2. Czy ktoś dostał kredyt, na który go nie stać? - na daned
Credit_History = 1 & [(LoanAmount*1000 / liczba rat) < (ApplicantIncome + CoapplicantIncome)]

3. Czy są typos w danych pierwotnych jakościowych?: 	- na pierwotnych danych
Gender, Married, Education, Self_Employed, Property_Area. 

4. Czy w tej zmiennej uporządkowanej są inne wartości niż NA, pusta kolumna, 0, 1, 2, 3+. ? 
Dependents - na pierwotnych danych

5. Czy zmienne ilościowe są większe równe 0? - na daned
