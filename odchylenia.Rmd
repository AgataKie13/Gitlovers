...
boxplot(dane2$Gender, dane2$Education, dane2$Credit_History, dane2$Self_Employed, names=c("Płeć", "Wykształcenie", "CreditHistory", "samozatrudnienie"))
boxplot(dane2$Married, dane2$Dependents, dane2$Property_Area, names=c("Married", "Dependents", "Property"))  #bez odchyleń
```
```{r}
